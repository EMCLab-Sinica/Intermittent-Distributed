 ...
 *
 * 
 *  Originally created on: 20170712
 *  Author: Meenchen
 *  Description: This simple DB is used to manage data and task snapshot(stacks)
 * 
 *  Modified on: 20200521
 *  Author: Tsai,Wei-Che
 *  Description: Modification for distributed scenario
 */
...
struct working
{ //working space of data for tasks
    void *address;
